...
class entClass(object):
    ...
    def __init__(self, word, start, end, label, nested = -1, idx = -1, level = -1):
        self.word = word
        self.start = start
        self.end = end
        self.label = label
    ...
    def __repr__(self):
        return self.word+':'+self.label+' ('+str(self.start)+','+str(self.end)+')' + 'nested: ' + str(self.nested) + 'level: ' + str(self.level)
